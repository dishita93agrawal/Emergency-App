...
export default class TheftScreen extends Component {
  constructor() {
    super();
    this.state = {
      theftItem: '',
  ...
  submitComplaint = async () => {
    db.collection('TheftComplaint').add({
      theftItem: this.state.theftItem,
      ...
      if (isAvailable) {
        ...
        const { result } = await SMS.sendSMSAsync(
          ...
          'Hello, I am ' +
            ...
            this.state.phoneno +
            '. I wanted to report an robbery of  ' +
            this.state.theftItem +
            ' at Address ' +
            this.state.address
        );
        ...
        <LinearGradient
          ...
          <View
            ...
            <DropDownPicker
              ...
              value={this.state.theftItem}
              setOpen={() => {
                this.setState({ open: !this.state.open });
              }}
              onSelectItem={(val) => {
                this.setState({ theftItem: val.label });
              }}
              style={{
                width: '75%',
                height: 40,
